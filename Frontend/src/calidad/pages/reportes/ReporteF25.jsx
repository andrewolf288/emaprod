...
export const ReporteF25 = () => {
  const ENCABEZADO = {
    titulo: 'CONTROL DE VEHICULOS DE TRANSPORTE DE PRODUCTO TERMINADO - TRAZABILIDAD',
    subtitulo1: 'EMACAL-F25',
    subtitulo2: 'Emisión: 01/10/2009',
    subtitulo3: 'Edición: 10',
    subtitulo4: 'Revisión: 05/01/2022',
    subtitulo5: 'Página 1 de 1'
  }

  const {
    loading,
    dateState, handleEndDateChange,
  ...
  const exportDataExcel = () => {
    ...
    console.log(data)
    const URL = '/calidad/reportes/reporte-emacal-F25.php'
    submitDataFilterToExcel(URL, data, 'reporte-emacal-F25.xlsx')
  }

  return (
    <>
      <div className="container-fluid mx-3">
        <h1 className='text-center'>Reporte de calidad F25</h1>
