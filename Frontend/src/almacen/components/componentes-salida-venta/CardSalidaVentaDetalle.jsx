...
export const CardSalidaVentaDetalle = ({ detalle, index }) => {
          ...
          <Table>
            ...
            <TableBody>
              <TableRow>
                ...
                <TableCell align="center">Sin acciones</TableCell>
              </TableRow>
            </TableBody>
          </Table>
        </TableContainer>
        {mostrarDetalle && <RowDetalleSalidasVentaDetalle detalle={detalle} />}
      </div>
    </div>
  );
};
