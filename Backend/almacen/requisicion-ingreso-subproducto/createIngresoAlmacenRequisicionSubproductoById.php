...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $idReqIngSub = $data["id"]; // id de requisicion ingreso
    ...
    if ($pdo) {
        try {
            ...
            $docEntSto = "SUBPRODUCTO";
            $idEntStoTip = 2; // entrada de produto intermedio
            ...
            $stmt_insert_entrada_stock->bindParam(14, $idReq, PDO::PARAM_INT);
            ...
            SET fecProdReqIngAlm = ?, esComReqProdIng = ?
            WHERE id = ?";
            ...
            $stmt_update_produccion_ingreso_producto->bindParam(2, $esComReqProdIng, PDO::PARAM_BOOL);
            $stmt_update_produccion_ingreso_producto->bindParam(3, $idReqIngSub, PDO::PARAM_INT);
