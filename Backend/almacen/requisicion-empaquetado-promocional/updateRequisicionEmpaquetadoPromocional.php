...
if ($_SERVER["REQUEST_METHOD"] == "PUT") {
    ...
    $idReqEmpProm = $data["id"]; // requisicion agregacion detalle
    $canReqEmpPromDet = $data["canReqEmpPromDetNew"]; // cantidad de la requisicion agregacion
    ...
    if ($pdo) {
        ...
        $sql_update_detalle_requisicion_empaquetado_promocional =
            ...
            SET canReqEmpPromDet = $canReqEmpPromDet, fecActReqEmpDet = ?
            WHERE id = ?";
        ...
        try {
            ...
            $stmt_update_detalle_requisicion_empaquetado_promocional->bindParam(2, $idReqEmpProm, PDO::PARAM_INT);
