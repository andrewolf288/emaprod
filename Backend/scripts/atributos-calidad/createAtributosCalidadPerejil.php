...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $atributos_calidad = [
        ...
        ['% DE IMPUREZAS', 1, '', NULL, NULL],
        ['GROSOR DE TALLO', 6, '1er corte (1-2 mm),2do corte (3-4 mm),3er corte (>5 mm)', 2, "GROSOR DE TALLO"],
        ['TAMAÑO (MAX. 25 CM)', 4, 'C,LI,I', NULL, NULL],
